...
namespace FoxDb
{
    public class EntityRelationPersister<T> : IEntityRelationPersister<T> where T : IPersistable
    {
        ...
        protected virtual DatabaseParameterHandler GetParameters<TRelation>(T item, TRelation child, IRelationConfig<T, TRelation> relation) where TRelation : IPersistable
        {
